...
| C++ on macOS (`build/mac-relwithdebinfo-801`) | **485 of 485 passing** (2026-09-10), 1 disabled -- see "C++ on macOS" |
...
Green: **485 of 485** on 2026-09-10, 54.6 s with `-j 4`, one entry
...
seven added since, three arrived with the merges and four are
`TestLibraryPaths`.
