...
public:
    ...
    {
        // Upstream routes this through Base::FileInfo::pathToString, which on
        // this fork still takes a boost::filesystem::path. std::filesystem
        // converts on its own, so ask the path directly.
        return _path.string();
    }
