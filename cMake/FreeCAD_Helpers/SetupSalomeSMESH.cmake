    ...
    if(BUILD_SMESH)
        ...
        if(UNIX OR WIN32)
            ...
            if(${VTK_MAJOR_VERSION} LESS 9)
                list(APPEND VTK_COMPONENTS vtkIOMPIParallel vtkParallelMPI vtkhdf5 vtkFiltersParallelDIY2 vtkRenderingCore vtkInteractionStyle vtkRenderingFreeType vtkRenderingOpenGL2 vtkWrappingPythonCore)
        ...
        # The python-wrapped half of FEM's post processing -- 28 python modules and
        # the C++ that answers them -- is compiled only when VTK ships its python
        # wrapper. Note VTK 9 only: the implementation uses modules added in 8.1,
        # and the found-variable is spelled differently before 9.0.
