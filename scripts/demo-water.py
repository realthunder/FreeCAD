...
try:
    ...
    # Visible sun disc along the scene light (feeds the bloom glow)
    render.SetBool("SunDisc", os.environ.get("SUNDISC", "1") == "1")
    render.SetFloat("SunDiscSize", float(os.environ.get("SUNDISC_SIZE", "1.5")))
