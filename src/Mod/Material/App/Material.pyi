...
class Material(BaseClass):
    ...
    CanonicalForm: Final[str] = ...
    """The card written in its canonical form: the bytes that are hashed and stored in a document."""

    ContentHash: Final[str] = ...
    """Hash of the canonical form. Identical content gives an identical hash on every installation."""
