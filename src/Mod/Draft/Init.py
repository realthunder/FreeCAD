...
# this fork has no App.addTranslatableExportType, which builds the filter
# string in the core and re-registers it when the language changes
App.addExportType(translate("FileFormat", "Flattened SVG") + " (*.svg)", "importSVG")
