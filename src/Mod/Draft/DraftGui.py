...
class DraftToolBar:
    ...
    def __init__(self):
        ...
        # upstream's Gui::ToolBar (a QToolBar with a drag grip) does not exist
        # in this fork, and UiLoader answers None for a class it cannot make
        self.tray = FreeCADGui.UiLoader().createWidget("Gui::ToolBar")
        if self.tray is None:
            self.tray = QtWidgets.QToolBar()
