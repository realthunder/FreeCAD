                ...
                if ((*i).visible) {
                    ...
                    for (IconQueue::iterator j = thisGroup.begin(); j != thisGroup.end(); ++j) {
                        ...
                        if (distSquared <= maxDistSquared
                            && (*i).type != QStringLiteraln1("Constraint_Symmetric")) {
...
void EditModeConstraintCoinManager::drawMergedConstraintIcons(IconQueue iconQueue)
{
    ...
    while (!iconQueue.empty()) {
        ...
        if (idString.length()) {
            idString.append(QStringLiteraln1(","));
        }
        ...
        while (i != iconQueue.end()) {
            ...
            idString.append(QStringLiteraln1(",") + QString::number(i->constraintId));
                                                       ...
                                                       int* vPad)
{
    ...
    constraintName << type.toUtf8().constData()
