...
void DrawViewPart::extractFaces(const ExtractFaceParams &params)
{
    ...
    if (newFaceFinder()) {
        findFacesNew(params, goEdges);
    } else {
        findFacesOld(params, goEdges);
    }
}

// use the revised face finder algo
void DrawViewPart::findFacesNew(const ExtractFaceParams &params,
...
void DrawViewPart::findFacesOld(const ExtractFaceParams &params,
                                const std::vector<BaseGeomPtr> &goEdges)
{
