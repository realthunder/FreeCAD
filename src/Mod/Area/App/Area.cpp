...
#include <Mod/Area/libarea/Area.h>
...
TYPESYSTEM_SOURCE(AreaLib::Area, Base::BaseClass)
...
std::vector<gp_Pnt> AreaLib::discretize(const TopoDS_Edge& edge, double deflection) {
