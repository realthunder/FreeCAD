...
public:
    ...
    static void setAxisXColor(const unsigned long &v);
    static const char *docAxisXColor();
    //@}
    ...
    static void setAxisYColor(const unsigned long &v);
    static const char *docAxisYColor();
    //@}
    ...
    static void setAxisZColor(const unsigned long &v);
