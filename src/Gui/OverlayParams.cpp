...
public:
    ...
    OverlayParamsP() {
        ...
        subHandles.resize(1);
        subHandles[0] = App::GetApplication().GetParameterGroupByPath("User parameter:BaseApp/Preferences/NaviCube");
        subHandles[0]->Attach(this);
        CornerNaviCube = this->subHandles[0]->GetInt("CornerNaviCube", 1);
        funcs["CornerNaviCube"] = &OverlayParamsP::updateCornerNaviCube;
        DockOverlayAutoView = this->handle->GetBool("DockOverlayAutoView", true);
        funcs["DockOverlayAutoView"] = &OverlayParamsP::updateDockOverlayAutoView;
        DockOverlayDelay = this->handle->GetInt("DockOverlayDelay", 200);
        funcs["DockOverlayDelay"] = &OverlayParamsP::updateDockOverlayDelay;
        DockOverlayRevealDelay = this->handle->GetInt("DockOverlayRevealDelay", 2000);
        funcs["DockOverlayRevealDelay"] = &OverlayParamsP::updateDockOverlayRevealDelay;
        DockOverlaySplitterHandleTimeout = this->handle->GetInt("DockOverlaySplitterHandleTimeout", 0);
        funcs["DockOverlaySplitterHandleTimeout"] = &OverlayParamsP::updateDockOverlaySplitterHandleTimeout;
        DockOverlayActivateOnHover = this->handle->GetBool("DockOverlayActivateOnHover", true);
        funcs["DockOverlayActivateOnHover"] = &OverlayParamsP::updateDockOverlayActivateOnHover;
        DockOverlayAutoMouseThrough = this->handle->GetBool("DockOverlayAutoMouseThrough", true);
        funcs["DockOverlayAutoMouseThrough"] = &OverlayParamsP::updateDockOverlayAutoMouseThrough;
        DockOverlayWheelPassThrough = this->handle->GetBool("DockOverlayWheelPassThrough", true);
        funcs["DockOverlayWheelPassThrough"] = &OverlayParamsP::updateDockOverlayWheelPassThrough;
        DockOverlayWheelDelay = this->handle->GetInt("DockOverlayWheelDelay", 1000);
        funcs["DockOverlayWheelDelay"] = &OverlayParamsP::updateDockOverlayWheelDelay;
        DockOverlayAlphaRadius = this->handle->GetInt("DockOverlayAlphaRadius", 2);
        funcs["DockOverlayAlphaRadius"] = &OverlayParamsP::updateDockOverlayAlphaRadius;
        DockOverlayCheckNaviCube = this->handle->GetBool("DockOverlayCheckNaviCube", true);
        funcs["DockOverlayCheckNaviCube"] = &OverlayParamsP::updateDockOverlayCheckNaviCube;
        DockOverlayHintTriggerSize = this->handle->GetInt("DockOverlayHintTriggerSize", 16);
        funcs["DockOverlayHintTriggerSize"] = &OverlayParamsP::updateDockOverlayHintTriggerSize;
        DockOverlayHintSize = this->handle->GetInt("DockOverlayHintSize", 8);
        funcs["DockOverlayHintSize"] = &OverlayParamsP::updateDockOverlayHintSize;
        DockOverlayHintLeftLength = this->handle->GetInt("DockOverlayHintLeftLength", 100);
        funcs["DockOverlayHintLeftLength"] = &OverlayParamsP::updateDockOverlayHintLeftLength;
        DockOverlayHintRightLength = this->handle->GetInt("DockOverlayHintRightLength", 100);
        funcs["DockOverlayHintRightLength"] = &OverlayParamsP::updateDockOverlayHintRightLength;
        DockOverlayHintTopLength = this->handle->GetInt("DockOverlayHintTopLength", 100);
        funcs["DockOverlayHintTopLength"] = &OverlayParamsP::updateDockOverlayHintTopLength;
        DockOverlayHintBottomLength = this->handle->GetInt("DockOverlayHintBottomLength", 100);
        funcs["DockOverlayHintBottomLength"] = &OverlayParamsP::updateDockOverlayHintBottomLength;
        DockOverlayHintLeftOffset = this->handle->GetInt("DockOverlayHintLeftOffset", 0);
        funcs["DockOverlayHintLeftOffset"] = &OverlayParamsP::updateDockOverlayHintLeftOffset;
        DockOverlayHintRightOffset = this->handle->GetInt("DockOverlayHintRightOffset", 0);
        funcs["DockOverlayHintRightOffset"] = &OverlayParamsP::updateDockOverlayHintRightOffset;
        DockOverlayHintTopOffset = this->handle->GetInt("DockOverlayHintTopOffset", 0);
        funcs["DockOverlayHintTopOffset"] = &OverlayParamsP::updateDockOverlayHintTopOffset;
        DockOverlayHintBottomOffset = this->handle->GetInt("DockOverlayHintBottomOffset", 0);
        funcs["DockOverlayHintBottomOffset"] = &OverlayParamsP::updateDockOverlayHintBottomOffset;
        DockOverlayHintTabBar = this->handle->GetBool("DockOverlayHintTabBar", false);
        funcs["DockOverlayHintTabBar"] = &OverlayParamsP::updateDockOverlayHintTabBar;
        DockOverlayHideTabBar = this->handle->GetBool("DockOverlayHideTabBar", true);
        funcs["DockOverlayHideTabBar"] = &OverlayParamsP::updateDockOverlayHideTabBar;
        DockOverlayHintDelay = this->handle->GetInt("DockOverlayHintDelay", 200);
        funcs["DockOverlayHintDelay"] = &OverlayParamsP::updateDockOverlayHintDelay;
        DockOverlayAnimationDuration = this->handle->GetInt("DockOverlayAnimationDuration", 200);
        funcs["DockOverlayAnimationDuration"] = &OverlayParamsP::updateDockOverlayAnimationDuration;
        DockOverlayAnimationCurve = this->handle->GetInt("DockOverlayAnimationCurve", 7);
        funcs["DockOverlayAnimationCurve"] = &OverlayParamsP::updateDockOverlayAnimationCurve;
        DockOverlayHidePropertyViewScrollBar = this->handle->GetBool("DockOverlayHidePropertyViewScrollBar", false);
        funcs["DockOverlayHidePropertyViewScrollBar"] = &OverlayParamsP::updateDockOverlayHidePropertyViewScrollBar;
        DockOverlayMinimumSize = this->handle->GetInt("DockOverlayMinimumSize", 30);
    ...
    static void updateCornerNaviCube(OverlayParamsP *self) {
        auto v = self->subHandles[0]->GetInt("CornerNaviCube", 1);
