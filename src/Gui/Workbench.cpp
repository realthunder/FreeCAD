...
MenuItem* StdWorkbench::setupMenuBar() const
{
    ...
    *view << "Std_ViewCreate" << "Std_ViewSplitRight" << "Std_ViewSplitDown" << "Std_ViewSplitClose" << "Std_ViewCellShowObject" <<"Std_OrthographicCamera" << "Std_PerspectiveCamera" << "Std_MainFullscreen" << "Separator"
