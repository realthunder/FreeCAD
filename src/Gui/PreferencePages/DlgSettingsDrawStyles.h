 ...
 * This class is auto generated by Gui/PreferencePages/DlgSettingsDrawStyles.py. Modify that file
 ...
 * @code
 *     python3 -m cogapp -r Gui/PreferencePages/DlgSettingsDrawStyles.h Gui/PreferencePages/DlgSettingsDrawStyles.cpp
 * @endcode
 */
