...
#else
    wbs_ordered_list = wbs_ordered.split(QStringLiteral(","), QString::SkipEmptyParts);
#endif
...
#else
    unfiltered_disabled_wbs_list = disabled_wbs.split(QStringLiteral(","), QString::SkipEmptyParts);
#endif
