...
private:
    ...
    void retranslateUi() {
        ...
        {
            actions[i]->setText(QString::fromStdString(Base::UnitsApi::getDescription(static_cast<Base::UnitSystem>(i))));
        }
    }
};
...
QPixmap MainWindow::splashImage() const
{
    ...
    if (tc != App::Application::Config().end()) {
        ...
        QString suffix  = QString::fromUtf8(App::Application::Config()["BuildVersionSuffix"].c_str());
