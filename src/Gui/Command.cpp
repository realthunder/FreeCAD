...
{
    try {
        bool recordViewObject = false;
        const char *transactionName = displayText.c_str();
        if (App::DocumentParams::getViewObjectTransaction()) {
            recordViewObject = true;
        }
        else {
            if (eType & NoTransaction) {
                transactionName = "";
            }
            else if (eType & ViewTransaction) {
                recordViewObject = true;
            }
        }
