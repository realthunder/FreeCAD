 ...
 *
 * This class is auto generated by D:/works/sw/fcad/src/Gui/RenderParams.py. Modify that file
 ...
 * @code
 *     python3 -m cogapp -r D:/works/sw/fcad/src/Gui/RenderParams.h D:/works/sw/fcad/src/Gui/RenderParams.cpp
 * @endcode
 *
 * You can add a new parameter by adding lines in D:/works/sw/fcad/src/Gui/RenderParams.py. Available
 ...
 * And you need to provide a function implementation in D:/works/sw/fcad/src/Gui/RenderParams.cpp with
...
public:
    ...
    static void setPreMeshOnLoad(const bool &v);
    static const char *docPreMeshOnLoad();
    //@}
