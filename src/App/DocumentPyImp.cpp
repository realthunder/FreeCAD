...
PyObject*  DocumentPy::addProperty(PyObject *args, PyObject *kwd)
{
    ...
    static const std::array<const char *, 10> kwlist{"type", "name", "group", "doc", "attr",
                                                     "read_only", "hidden", "locked",
                                                     "enum_vals", nullptr};
    if (!Base::Wrapped_ParseTupleAndKeywords(
            args, kwd, "ss|sethO!O!O!O", kwlist, &sType, &sName, &sGroup, "utf-8",
            &sDoc, &attr, &PyBool_Type, &ro, &PyBool_Type, &hd, &PyBool_Type, &lk, &enumVals)) {
        return nullptr;
    }
...
PyObject* DocumentPy::settings(PyObject* args)
{
...
PyObject* DocumentPy::snapshotTransactionLog(PyObject *args)
{
    if (!PyArg_ParseTuple(args, ""))
        return nullptr;
    PY_TRY {
        return Py::new_reference_to(Py::Long(static_cast<long>(getDocumentPtr()->snapshotToLog())));
    } PY_CATCH;
}
