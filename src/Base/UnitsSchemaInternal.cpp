...
UnitsSchemaInternal::schemaTranslate(const Quantity& quant, double& factor, std::string& unitString)
{
    ...
    if (unit == Unit::Length) {  // Length handling ============================
        ...
        if (UnitValue < 0.001) {
            static const std::string unitUmmk = "\xC2\xB5m/m/K";  // micro-meter/meter/K
            unitString = unitUmmk;
            factor = 1e-6;
        }
        else {
        ...
        if (UnitValue < 1e-9) {
            static const std::string unituS = "\xC2\xB5S";
            unitString = unituS;
            factor = 1e-12;
        }
        ...
        if (UnitValue < 1e-15) {
            ...
            static const std::string unitpF = "\xC2\xB5" "F";
            unitString = unitpF;
            factor = 1e-12;
        }
        else if (UnitValue < 1e-6) {
        ...
        if (UnitValue < 1e-6) {  // smaller than 0.001 1/km -> scientific notation
            ...
            static const std::string unit1um = "1/\xC2\xB5m";
            unitString = unit1um;
            factor = 1e3;
        }
        else if (UnitValue < 1e9) {
